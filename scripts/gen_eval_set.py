...
RAG_GOLD = [
    ("电源功率怎么算", ["01_电源选购与功率计算.md"]),
    ("80PLUS 金牌认证值得买吗", ["01_电源选购与功率计算.md"]),
    ("ATX 3.0 电源有什么好处", ["01_电源选购与功率计算.md"]),
    ("DDR4 和 DDR5 应该怎么选", ["02_DDR4与DDR5怎么选.md"]),
    ("AM5 平台内存频率选多少合适", ["02_DDR4与DDR5怎么选.md", "06_内存容量与频率指南.md"]),
    ("游戏和生产力 CPU 怎么挑", ["03_CPU选购指南.md"]),
    ("9800X3D 为什么适合游戏", ["03_CPU选购指南.md"]),
    ("显卡按分辨率怎么选档位", ["04_显卡选购指南.md"]),
    ("2K 分辨率配什么显卡", ["04_显卡选购指南.md"]),
    ("A 卡和 N 卡怎么分", ["04_显卡选购指南.md"]),
    ("选主板第一步看什么", ["05_主板选购指南.md"]),
    ("B760 和 Z790 有什么区别", ["05_主板选购指南.md"]),
    ("内存容量 16G 够用吗", ["06_内存容量与频率指南.md"]),
    ("双通道有什么必要", ["06_内存容量与频率指南.md"]),
    ("5000 元装机怎么配", ["07_5000元装机配置.md"]),
    ("8000 元装机思路是什么", ["08_8000元装机配置.md"]),
    ("15000 元装机怎么配", ["09_15000元装机配置.md"]),
    ("i9 级别用什么散热", ["10_散热器选购指南.md"]),
    ("风冷和水冷哪个好", ["10_散热器选购指南.md"]),
    ("机箱风道怎么设计", ["11_机箱与风道指南.md"]),
    ("显卡限长怎么看", ["11_机箱与风道指南.md"]),
    ("PCIe 4.0 和 5.0 差距大吗", ["12_PCIe世代与带宽科普.md"]),
    ("老主板插新显卡会损失性能吗", ["12_PCIe世代与带宽科普.md"]),
    ("装机最容易翻车的兼容性问题", ["13_装机兼容性避坑清单.md"]),
    ("下单前应该核对哪些兼容性", ["13_装机兼容性避坑清单.md"]),
    ("固态硬盘容量怎么选", ["14_固态硬盘选购指南.md"]),
    ("PCIe 5.0 固态值得买吗", ["14_固态硬盘选购指南.md", "12_PCIe世代与带宽科普.md"]),
]
...
def main() -> None:
    ...
    items += [{"type": "rag", "question": q, "expected": {"doc_names": docs}} for q, docs in RAG_GOLD]
